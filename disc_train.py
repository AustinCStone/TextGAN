    ...
    with tf.Session() as sess:
        ...
        for e in range(args.num_epochs):
            ...
            for b in range(data_loader.num_batches):
                ...
                feed = {model.input_data: x, model.targets: np.random.randint(2, size=args.batch_size).astype('float32').reshape((50, 1)), model.initial_state: state}
